...
export default function CollectionPage({ paletteList, setPaletteList }: CollectionPageProps) {
  ...
  return (
    <div className="px-2 gap-2 bg-Secondary rounded-[2px] shadowCorner border-b-2 border-x-2 border-custom-black [corner-shape:notch] flex flex-col items-center justify-start h-full w-full overflow-y-auto overflow-x-hidden py-2 ">
        ...
        <div className="grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 grid-cols-1 gap-2 w-full">
            {paletteList.map((palette, index) => (
              <PixelOutline key={index} className="h-full flex flex-col justify-between gap-2 bg-Quaternary rounded-[2px] [corner-shape:notch] shadowCorner border-2 border-custom-black p-2">
                <div className="flex flex-col gap-2">
                  <div className="flex flex-row items-center justify-between gap-2">
                    {editingIndex === index ? (
                      ...
                      />
                      <PixelOutline className="w-8 h-8 bg-Primary hover:-translate-y-0.5 active:translate-y-0.5 rounded-[2px] shadowCorner border-2 [corner-shape:notch] border-custom-black cursor-pointer bg-Secondary flex items-center justify-center p-1"
                      ...
                      <div className="flex gap-2">
                        ...
                        <PixelOutline className="w-8 h-8 bg-Tertiary hover:-translate-y-0.5 active:translate-y-0.5 rounded-[2px] shadowCorner border-2 [corner-shape:notch] border-custom-black cursor-pointer bg-Secondary flex items-center justify-center p-1"
                ...
                <PixelOutline className="bg-Primary hover:-translate-y-0.5 active:translate-y-0.5 rounded-[2px] shadowCorner border-2 [corner-shape:notch] border-custom-black cursor-pointer bg-Secondary flex items-center justify-center py-1 px-2"
